...
![TaskMate Banner](https://img.shields.io/badge/Status-Production%20Ready-brightgreen) ![React](https://img.shields.io/badge/Frontend-React%2019-blue) ![Supabase](https://img.shields.io/badge/Backend-Supabase-green) ![License](https://img.shields.io/badge/License-MIT-yellow)
...
TaskMate is a full-stack web application that operates as a **digital service marketplace** for Nigeria. It bridges the gap between service consumers ("Customers") and skilled professionals ("Providers") by providing:
