...
const ProviderSidebar = () => {
    ...
    const navItems = [
        ...
        { icon: 'calendar_month', label: 'Schedule', href: '/provider/schedule' },
                        ...
                        <>
                            <img
                                ...
                                src={
                                    ...
                                    `https://ui-avatars.com/api/?name=${encodeURIComponent(currentUser?.displayName || currentUser?.full_name || 'Provider')}&background=f0fdf4&color=15803d`
                                }
                            />
                            <div className="flex flex-col text-left overflow-hidden flex-1">
                                <span className="text-[13px] font-bold text-gray-900 truncate group-hover:text-red-600 transition-colors">
                                    {currentUser?.displayName || currentUser?.full_name || 'Provider'}
                                </span>
